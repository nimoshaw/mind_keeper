...
- `inspect_canonical_governance` now gives operators and external readers one read-only governance view instead of making them stitch together stale, noisy, and conflict state by hand
